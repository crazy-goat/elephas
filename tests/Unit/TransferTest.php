...
class TransferTest extends TestCase
{
    public function testConstructorAndGetters(): void
    {
        ...
        $this->assertTrue($amount->equals($transfer->getAmount()));
    ...
    public function testDefaultValuesAreZero(): void
    {
        ...
        $transfer = new Transfer($zero, $zero, $zero, $zero, $zero, $zero);

        $this->assertTrue($transfer->getAmount()->isZero());
    ...
    public function testLargeAmountValue(): void
    {
        ...
        $transfer = new Transfer($zero, $zero, $zero, $zero, $zero, $large);

        $this->assertTrue($transfer->getAmount()->equals($large));
        $this->assertSame('340282366920938463463374607431768211455', $transfer->getAmount()->toString());
    }
}
