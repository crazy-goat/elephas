...
- Replaced `--privileged` Docker flag with a custom seccomp profile when starting TigerBeetle in CI, reducing the CI security surface to only the syscalls required by TigerBeetle (#130)
